...
import { Apple, Download as DownloadIcon, Monitor, ArrowRight, Check, Sparkles, RefreshCcw, Zap, Lock, Loader2 } from "lucide-react";
...
const WIN_DOWNLOAD_URL = "https://github.com/claselyexplore/clipiee-releases/releases/download/Clasely/Clipiee.Setup.1.0.1.exe";
                                        ...
                                        <CardContent className="space-y-8 pt-4 pb-10">
                                            <Button
                                                ...
                                                className={cn(
                                                    ...
                                                    "bg-muted text-muted-foreground cursor-not-allowed opacity-80 hover:opacity-80"
                                                )}
                                            >
