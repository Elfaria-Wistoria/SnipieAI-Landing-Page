...
export default function BottomCTA() {
    ...
    return (
        <section ref={ref} className="relative py-32 overflow-hidden bg-[#ffffff]">
            {/* Background */}
            ...
            <div className="container px-4 relative z-10">
                ...
                >
                    <h2 className="text-4xl md:text-6xl font-semibold tracking-tight mb-6 text-gray-900">
                        Ready to <span className="bg-gradient-to-r from-[#6D28D9] via-[#7C3AED] to-[#C4B5FD] bg-clip-text text-transparent">make clips</span> the smart way?
                    </h2>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Link href="https://drive.google.com/drive/folders/1ozHuB4uJaEGipYwBUbh9-Yr__l8Ibr5i?usp=sharing" target="_blank" rel="noopener noreferrer">
                            <Button size="lg" className="rounded-full h-14 px-10 text-lg bg-[#7C3AED] hover:bg-[#6D28D9] text-white font-medium transition-all shadow-lg shadow-[#7C3AED]/25 hover:shadow-xl hover:shadow-[#7C3AED]/30 hover:scale-[1.02]">
                                Get Started for Free
                                <ArrowRight className="ml-2 h-5 w-5" />
                            </Button>
                        </Link>
                        <Link href="/#pricing">
                            <Button variant="outline" size="lg" className="rounded-full h-14 px-10 text-lg border-2 border-gray-200 text-gray-700 hover:border-[#7C3AED] hover:text-gray-900 bg-white/60 hover:bg-white transition-all">
                                See Pricing
                            </Button>
                        </Link>
                    </div>
